...
public class BT_Comm {
    ...
    public boolean initBT(){
        ...
        Log.d("local adapter bluetooth", "initBT: "+ localAdapter);
    ...
    public void writeMessage2(MessageBluetooth msg) throws InterruptedException{
        BluetoothSocket connSock;
        ...
        if(connSock!=null){
            try {
                ...
                //ObjectOutputStream out = new ObjectOutputStream(connSock.getOutputStream());
                OutputStream outputStream = connSock.getOutputStream();
